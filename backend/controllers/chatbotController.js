...
const getPopupMessages = async (req, res) => {
  ...
  try {
    ...
    let popupMessages = [
      ...
      "🚀 Smart Utkal Tree AI Assistant",

      "📘 Search Department Policies Instantly",

      "📗 Search SOP Documents Smartly",

      "⚡ Chat Naturally Like Real AI",
    ...
    popupMessages =
      [...new Set(popupMessages)];

    return res.json(
      popupMessages.slice(0, 50)
    );
